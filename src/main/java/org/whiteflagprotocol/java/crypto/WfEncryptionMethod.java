...
public enum WfEncryptionMethod {
     ...
     */
    AES_PRESHARED("1", "AES/CTR/NoPadding", 32, "8ddb03085a2c15e69c35c224bce2952dca7878770724741cbce5a135328be0c0"),

    /**
     * Encryption Method 2: AES-256-CTR with negotiated key
     */
    AES_NEGOTIATED("2", "AES/CTR/NoPadding", 32, "c4d028bd45c876135e80ef7889835822a6f19a31835557d5854d1334e8497b56");
     ...
     * @param algorithm the encryption algorithm, mode and padding i.a.w. Java Cryptography Standard Algorithm Names
     ...
     */
    private WfEncryptionMethod(final String indicator, final String algorithm, final int keyLength, final String hkdfSalt) {
    ...
    /**
     * Returns the Whiteflag indicator for the encryption method
     * @return string with value used in a Whiteflag message to indicate the encryption method
     */
    ...
    /**
     * Returns the encryption algorithm for the encryption method
     * @return the encryption algorithm, mode and padding i.a.w. Java Cryptography Standard Algorithm Names
     */
    ...
    /**
     * Returns the encryption key length for the encryption method
    ...
    /**
     * Returns the salt for key derivation for the encryption method
